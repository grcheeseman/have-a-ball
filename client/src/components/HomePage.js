...
function HomePage() {
  return (
    <div>
      <div className="bg-slate-400/75 rounded px-20">
        ...
        <h2 className="tracking-widest text-center text-2xl m-5 font-bold">Our Story</h2>
        <p className="text-xl text-center m-5">
          We are looking to connect knitters and fiber artists to one another
          via events in their neighborhoods. </p>
        <p className="text-xl text-center m-5">
        ...
        <Link to="/login">
          <button className="text-xl text-center bg-blue-100/75 rounded-lg w-36 h-12 py-2 m-5">
            Log In Here!
          </button>
        </Link>
      </div>
