    ...
    return(
        <div>
            <div className='bg-slate-400/75 rounded px-20 w-3/4 mt-36 mb-36'>
                <h1 className="tracking-widest text-3xl m-5 mb-10 font-bold">Welcome to Have a Ball!</h1>
                <p className = "text-center text-xl">We're on a mission to connect fiber artists with one another!</p>
                <h2 className="tracking-widest text-2xl m-5 font-bold">Our Story</h2>
                <p className = "text-xl m-5">We are looking to connect knitters and fiber artists to one another via </p>
